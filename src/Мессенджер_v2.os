...
//
Функция ОтправитьСообщение(ИмяТранспорта, Адресат, Сообщение, ТемаСообщения = "", ТипСообщения = "", ПараметрыСообщения = Неопределено) Экспорт
	...
	Возврат Транспорт.ОтправитьСообщение(Адресат, Сообщение, ДополнительныеПараметры);
